...
export function PostCard({
  ...
  return (
    <Link
      href={`/${uid}`}
      className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted rounded-md overflow-hidden shadow-2xl hover:shadow-xl transition-all duration-300 ease-in-out border border-white/10 hover:border-white/30"
    >
